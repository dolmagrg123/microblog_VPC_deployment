...
ssh -i "workload_4.pem" ubuntu@${APPLICATION_SERVER_IP} 'curl -o ~/start_app.sh https://raw.githubusercontent.com/dolmagrg123/microblog_VPC_deployment/main/scripts/start_app.sh && bash ~/start_app.sh'
